...
import com.locker.be.web.product.service.ProductTradeTypeService;
...
@RequestMapping("web/product/trade/type")
...
public class ProductTradeTypeApi {
    ...
    public void create(@RequestBody final ProductTradeTypeDto.ProductTradeTypeReq dto) {
